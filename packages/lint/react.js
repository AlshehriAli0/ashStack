...
// you-might-not-need-an-effect, TanStack Query, and naming rules.
...
const react = {
  ...
  rules: {
    ...
    "shared/no-inline-tanstack-query-keys": "error",
    "shared/no-deprecated-tanstack-query-filters": "error",
    "shared/require-destructured-query-hooks": "error",
    "shared/no-fetch-in-query-fn": "error",
    "shared/next-page-param-undefined": "error",
    "shared/require-zustand-selector": "error",
    "shared/hoist-intl": "error",
    "shared/no-naming-convention": "error",

...
// plugin files and deps may not be reachable (pnpm, nested installs). Resolving
// to absolute paths here — at config load time, from this package's location —
...
export default {
  ...
  rules: {
    ...
    "shared/prefer-zod-enum": "error",
    "shared/comment-escape-hatch": "error",
  },
  overrides: [
    {
      files: ["**/*.tsx"],
    ...
    },
    {
      ...
      rules: {
        ...
        "shared/comment-escape-hatch": "off",
      },
    },
  ],
};

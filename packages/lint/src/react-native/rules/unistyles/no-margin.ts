...
const MESSAGE =
  "Use `gap` on the parent or `padding` on this element instead of `margin` — margin escapes the child's box and leaves stray space behind. A negative margin and `0` stay allowed.";

...
const react = (options = {}) => {
  ...
  return mergeConfigs(core(options), {
    ...
    rules: {
      ...
      "@ashstack/core/hoist-intl": "error",
      "@ashstack/core/no-naming-convention": "error",
      "unicorn/filename-case": ["error", { cases: { kebabCase: true, pascalCase: true } }],
      ...(query && {
        "@ashstack/query/no-inline-keys": "error",
        "@ashstack/query/no-deprecated-filters": "error",
        "@ashstack/query/require-destructured-hooks": "error",
        "@ashstack/query/no-fetch-in-query-fn": "error",
        "@ashstack/query/next-page-param-undefined": "error",
      }),
      ...(zustand && { "@ashstack/zustand/require-selector": "error" }),
      ...(i18n && {
        "@ashstack/i18n/no-bare-text": "error",
        "@ashstack/i18n/no-bare-attrs": "error",
        "@ashstack/i18n/no-bare-toast": "error",
      }),
    },
    overrides: [
      {
